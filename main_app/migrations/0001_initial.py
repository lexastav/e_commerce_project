    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Всего к оплате')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.AddField(
            model_name='cart',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.customer', verbose_name='Владелец'),
        ),
        migrations.AddField(
            model_name='cart',
            name='products',
